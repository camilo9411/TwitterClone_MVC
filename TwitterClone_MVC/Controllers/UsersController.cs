...
namespace TwitterClone_MVC.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstMidName,LastName,Email,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstMidName,LastName,Email,Password")] User user)
        {
            if (id != user.ID)
            {
                return NotFound();
